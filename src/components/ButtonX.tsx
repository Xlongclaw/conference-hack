...
const ButtonX:React.FC<{variant:number;title:string}> = (props) => {
  const style0 = `flex justify-center items-center px-10 py-6 rounded-3xl border-custom-lightDark border-[2px] h-[2rem] font-semibold hover:bg-custom-lightDark cursor-pointer hover:text-custom-white hover:transition-all transition-all`;
  const style1 = `flex justify-center items-center px-10 py-6 rounded-3xl border-custom-lightDark border-[2px] h-[2rem] font-semibold hover:bg-custom-lightDark cursor-pointer hover:text-custom-white hover:transition-all transition-all`;
