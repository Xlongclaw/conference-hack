...
const ButtonX: React.FC<{ variant: number; title: string }> = (props) => {
  ...
  const style1 = `flex justify-center text-custom-orange items-center px-10 py-6 border-custom-orange border-[1px] text-sm h-[2rem] font-semibold hover:bg-custom-orange cursor-pointer hover:text-custom-white hover:transition-all transition-all`;
